...
export default
  [
    ...
    content: 'Calling all creatives, developers, makers, activists, and for-profit and non-profit entrepreneurs!<br>Elevate your ideas by crafting them in Unreal Engine 5 or Unity 3D.<br>Showcase your projects globally via browser, mobile, desktop, VR, or WebVR platforms out of the box.<br><br>But don’t worry about the tools; use what works for you—HTML, JS, CSS, APIs (JAMstack), WASM (WebAssembly for C, C++, Rust), or WebContainers (Node.js in the browser).<br>Enjoy the freedom of creativity with backend scaling that’s 99% automated and no lock-in constraints.<br><br>No coding experience? No problem! Easily create full-fledged games and applications.<br><br>What’s holding you back from creating today?<br>Break free from environmental limitations and seamlessly transition between your diverse creations as if they were part of a vast, interconnected game world.<br>Dive in now!',
  ...
  { key: `11`,
    ...
    content: 'Welcome to Cloud Atlas, a visionary project that transforms the way we interact with information and each other. At its heart lies a planetary collective-computer, a web application that mirrors our world through a digital lens. This virtual realm, a cartographic echo of reality, is ripe for exploration and enrichment.<br><br>As a contributor, your mission is to capture, refine, and narrate the essence of places, combating the fog of distortion with clarity and precision. By tethering playful Wikipedia narratives to their physical and temporal anchors, you become a guardian of truth, ensuring the digital and the real harmoniously align.<br><br>The Virtual Encyclopedia stands as a beacon of accountability, juxtaposing the actions of authorities against the pillars of human rights, legal frameworks, and global objectives. It scrutinizes the alignment of governance with the immutable standards of truth across diverse domains, from STEM to HASS, and beyond. Joining Cloud Atlas means more than contributing to a database; it’s about becoming a neuron in a collective consciousness that spans both AI and humanity. Traverse this open-source connectome, where decentralized computing and collaboration elevate our collective intellect.<br><br>Embrace the revolution. Decentralize. Connect. Enrich the Cloud Atlas.',
  ...
  { key: `19`,
    ...
    content: '<strong>- CITIZENS:</strong> Create and participate in community and global initiatives, brainstorm solutions, and support projects that matter to you via Crowdfunding or get funding for your own projects. (coming "Get paid for the subject you love!")<br> <strong>- PROFESSIONALS, SCIENTISTS AND HOBBYISTS:</strong> Collaborate on research, projects, and funding opportunities with a global network of contributors.<br> <strong>- STARTUPS:</strong> Utilize our platform to brainstorm, fund, and develop innovative solutions and initiatives.<br><strong>- POLITICIANS AND POLICYMAKERS:</strong> Engage with citizens to gather innovative solutions and diverse perspectives on public and private matters.<br><strong> - NONPROFITS and NGOs:</strong> Leverage our platform to gather support, co-develop new initiatives with real-time feedback from those affected (also by your solutions).<br><strong>- BUSINESSES:</strong> Enhance corporate social responsibility, engage in community projects, and co-create products and services with real-time feedback from users.',
