...
export default
  [
    ...
    content: 'Calling all creatives, developers, makers, activists, and for-profit and non-profit entrepreneurs!<br><br>Don’t worry too much about the tools; just use what works for you. Elevate your ideas by crafting them in Unreal Engine 5 or Unity 3D, HTML, CSS, JS, APIs (JAMstack), WASM (WebAssembly for C, C++, Rust), or WebContainers (Node.js in the browser).<br><br>Showcase your projects globally via browser, mobile, desktop, VR, or WebVR out of the box.<br>Enjoy the freedom of creativity with backend scaling that’s 99% automated and no lock-in constraints.<br><br>No coding experience? No problem! Easily create full-fledged games and applications with for instance Blueprints in UE or Chatgpt for applications based on our templates.<br><br>What’s holding you back from creating today?<br>Break free from environmental limitations and seamlessly transition between your diverse creations as if they were part of a vast, interconnected game world.<br>Dive in now!',
