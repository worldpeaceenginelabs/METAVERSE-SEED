...
export default
  [
    ...
    content: 'Whether you’re a creator, developer, activist, or for-profit or non-profit entrepreneur from any sector!<br><br>Don’t get hung up on the tools; pick what suits your flow. Elevate your concepts using <strong>Unreal Engine 5, Unity 3D,</strong> and/or <strong>HTML, CSS, JS, APIs</strong> (JAMstack), <strong>WASM</strong> (WebAssembly for C, C++, Rust), or <strong>WebContainers</strong> (Node.js in the browser). Then select a coordinate for your creation and initiate a GitHub issue (automation is in the works)<br><br>Launch your creations to a global audience across various platforms—be it <strong>browsers, mobile devices, desktops, VR, or WebVR, right out of the box.</strong> Enjoy the liberty of creation, supported by a <strong>backend that scales automatically by 99%, free from any restrictive ties.</strong><br><br><strong>Lacking coding skills? No worries!</strong> Craft complete games and apps with ease using Blueprints in UE, or you can use ChatGPT for applications based on the already existing components in the code on GitHub.<br><br>What’s stopping you from unleashing your creativity today? Liberate yourself from the constraints of your surroundings and navigate through diverse projects as if they were realms within an expansive, unified digital universe.<br><br>Take the plunge and start creating now!',
